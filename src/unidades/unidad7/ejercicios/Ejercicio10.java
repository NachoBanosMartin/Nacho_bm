...
public class Ejercicio10 {
	...
	public static void main(String[] args) {
		...
		System.out.println("La probabilidad de que haga sol es: " + probabilidadSol);
		System.out.println("La probabilidad de que haga frío es: " + probabilidadFrio);
	...
	public static String calcularProbabilidadLluvia(String presion, String humedad) {
	...
	public static String calcularProbabilidadSol(String presion, String humedad) {
	...
	public static String calcularProbabilidadFrio(String presion, String humedad) {
		if(presion.equals("baja") || (presion.equals("media") && humedad.equals("alta"))) {
			return "Alta";
